...
import Logo from '../assets/axlarislogo.png'
...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[70px] flex justify-between items-center px-4 bg-[#f5f4f3] text-gray-700 z-10">
        <div>
            <div onClick={() => scrollToPage('home')}>
                <img className="bg-[#f5f4f3] hover:bg-[#ffffff]" title="Home" src={Logo} alt="Logo" style={{width: '70px'}}/>
            </div>
        </div>
